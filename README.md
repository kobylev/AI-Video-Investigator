...
![AI Video Investigator dashboard — Dash Cam.mp4 ingested, Dual-Agent Pipeline Status showing all three stages complete (Edge Retrieval, Router Gate, Cloud Reasoner), Investigation Report rendered below](docs\images\p8_full_dashboard.png.png)
...
![AI Video Investigator Investigation Report — Router Decision ESCALATED, 99.94% On-Prem Filter Rate, Est. Cost $0.0090, three Cloud-Verified frame cards with forensic analysis summaries](docs\images\wp8_investigation_report.png.png)
