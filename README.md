...
![AI Video Investigator dashboard — Dash Cam.mp4 ingested, Dual-Agent Pipeline Status showing all three stages complete (Edge Retrieval, Router Gate, Cloud Reasoner), Investigation Report rendered below](docs/images/wp8_full_dashboard.png)
